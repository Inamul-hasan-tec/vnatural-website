...
import { Sparkles, Leaf, Heart, Shield, ArrowRight, Star, Stethoscope, Brain, Apple, Package, CheckCircle, Users, Globe, Zap, ShoppingCart, Activity, Bot, UserCheck, TrendingUp, Award, Target, Droplet, Wheat, Flame, Droplets, Pill, ShoppingBag } from 'lucide-react';
...
export default function Home() {
  const pillars = [
    {
      ...
      description: 'Direct sourcing of pure, organic, tribal, and regional products from verified farmers and producers.',
    ...
    },
    {
      ...
      description: 'Smart, guided shopping with fast delivery. Health-based discovery and personalized recommendations.',
    ...
    },
    {
      ...
      description: 'MedTel consultations + AI Virtual Doctor for 24/7 health guidance and continuous care.',
    ...
    },
    {
      ...
      description: 'Integrated nutrition, lifestyle guidance, and preventive care for long-term health.',
  ...
  const sourcingPrinciples = [
    { icon: CheckCircle, title: 'Direct Sourcing', desc: 'From farmers, FPOs, SHGs, tribal communities - no middlemen' },
    { icon: Shield, title: 'Verified Quality', desc: 'Physical verification of farms, units, and production processes' },
    { icon: Target, title: 'Batch-Level Checks', desc: 'Consistent quality assurance and testing for every batch' },
    { icon: Users, title: 'Customer Feedback', desc: 'Real market acceptance and customer reviews drive selection' },
    { icon: Globe, title: 'Ethical Practices', desc: 'Sustainable, transparent, and responsible sourcing always' },
    { icon: Award, title: 'No Compromise', desc: 'If we don\'t trust it, we don\'t source it - period' },
  ];
  ...
  const ecosystemLayers = [
    { icon: Apple, title: 'Natural & Healthy Food', desc: 'Pure products from verified sources' },
    { icon: Zap, title: 'Smart Commerce', desc: 'Interactive & quick delivery' },
    { icon: Stethoscope, title: 'Medical Consultation', desc: 'MedTel doctor support' },
    { icon: Bot, title: 'AI-Powered Support', desc: '24/7 virtual health assistant' },
    { icon: UserCheck, title: 'Nutrition & Lifestyle', desc: 'Personalized diet & wellness plans' },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <motion.div
              ...
              className="mb-6"
            >
              <span className="inline-block bg-white/95 backdrop-blur-sm text-emerald-800 px-8 py-3 rounded-full text-sm font-bold mb-4 shadow-2xl border-2 border-emerald-200">
            ...
            >
              Redefining <span className="bg-gradient-to-r from-vn-lime via-vn-lime-light to-vn-lime bg-clip-text text-transparent drop-shadow-2xl" style={{
                textShadow: '0 0 30px rgba(126, 211, 33, 0.8), 0 4px 20px rgba(0,0,0,0.5)',
              }}>Wellness</span>
            </motion.h1>
            ...
            >
              A next-generation wellness ecosystem delivering pure products, transparent sourcing, 
              smart commerce, and continuous health support—all under one trusted platform.
            </motion.p>
            ...
            >
              From farm to food • From food to health • From health to lifelong wellness
            </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {pillars.map((pillar, index) => (
              <motion.div
                ...
                whileHover={{ y: -10, scale: 1.02, boxShadow: "0 25px 50px -12px rgba(5, 150, 105, 0.25)" }}
              ...
              >
                <div className="absolute top-0 right-0 text-9xl font-bold text-emerald-50 opacity-50">
                  {pillar.number}
                </div>
                <motion.div
                ...
                <p className="text-gray-700 leading-relaxed text-lg relative z-10">{pillar.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {productCategories.map((category, index) => (
              ...
              >
                ...
                <p className="text-emerald-600 font-bold text-lg">{category.count}</p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              At VNatural, sourcing is responsibility, not procurement. 
              If we don't trust the process, people, or consistency—we simply don't source the product.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sourcingPrinciples.map((principle, index) => (
              ...
              >
                ...
                <p className="text-emerald-100 leading-relaxed">{principle.desc}</p>
              </motion.div>
            ))}
          </div>
          ...
          >
            <div className="bg-white/10 backdrop-blur-md border-2 border-white/30 rounded-2xl p-8 max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold mb-4">Global & Local Sourcing</h3>
              <p className="text-emerald-100 text-lg leading-relaxed">
                We source across India's regions and tribal belts, from traditional and indigenous producers, 
                and from ethical international sources. Whether local or global, every product meets one universal 
                VNatural standard: <span className="font-bold text-white">Purity • Authenticity • Health Value • Traceability</span>
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <h3 className="text-3xl font-bold mb-4 text-gray-900">MedTel – Digital Medical Support</h3>
              <p className="text-gray-700 mb-6 text-lg leading-relaxed">
                Access professional medical consultations from the comfort of your home.
              </p>
            ...
            >
              ...
              <h3 className="text-3xl font-bold mb-4 text-gray-900">AI Virtual Doctor – 24/7 Support</h3>
              <p className="text-gray-700 mb-6 text-lg leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-emerald-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Our Commitment to You</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
              {[
                ...
                >
                  <p className="font-bold text-lg text-emerald-300">{commitment}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto text-emerald-50 leading-relaxed">
              Join thousands who trust VNatural for authentic products, honest information, 
              and complete wellness support. Experience the difference today.
            </p>
            <motion.button
